...
export const config = {
  ...
  matcher: [
    "/((?!_next|favicon|icon|apple-icon|api|shop|orders|collectibles|play|vault|explore|ideas|quests|timeline|projects|report|hackatime|refers|account|docs|dashboard|img|fonts|pixl|index|hero-bg|step-|pixel_|hc-logo|og-boot-splash|world-map|flow-).*)",
  ],
};

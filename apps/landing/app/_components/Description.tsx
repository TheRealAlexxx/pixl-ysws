...
const videos = [
  ...
  // Cloudflare cached a 404 for the bare path from before this file existed
  // (s-maxage=31536000 on the edge), so the URL needs to change to bust it -
  // bumping this query param is now the way to force a fresh edge fetch.
  "/step-3.mp4?v=1#t=0.5",
  "/step-4.mp4",
  "/step-5.mp4",
];
